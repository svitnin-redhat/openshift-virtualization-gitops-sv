...
apiVersion: v1
metadata:
  name: pullsecret-ocp3m0w-ic4s18
stringData:
...
```sh
oc new-project ocp3m0w-ic4s18
oc apply -f ./bmc-credentials-secret.yaml -n ocp3m0w-ic4s18
oc apply -f ./pull-secret.yaml -n ocp3m0w-ic4s18
```
